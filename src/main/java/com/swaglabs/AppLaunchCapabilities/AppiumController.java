...
public class AppiumController {
    ...
    public void appLaunch(Properties config) throws MalformedURLException {
        ...
        String appiumUrl = "http://" + config.getProperty("APPIUM_IP") + ":" + config.getProperty("APPIUM_PORT")
                + "/wd/hub";
        String cloudUrl = "http://" + config.getProperty("UNAME") + ":" + config.getProperty("ACCESS_KEY") + "@"
                + config.getProperty("SAUCELABS_URL") ;
        ...
        switch (config.getProperty("OS")) {
            ...
            case "IOS":
                ...
                // config.getProperty("IOS_BROWSER_NAME"));
                ...
                if (config.getProperty("HOST").equalsIgnoreCase("CLOUD")) {
                    ...
                    driver = new IOSDriver<MobileElement>(new URL(config.getProperty("SEETEST_URL")), capabilities);
                } else {
                    capabilities.setCapability(MobileCapabilityType.APP, app.getAbsolutePath());
